...
package com.kevin.viewlibrary.swipe;
 ...
 *
 //设置初始为刷新状态
 //srlGeneralMovie.post(this::setSwipeRefreshLoadingState);
 //srlGeneralMovie.setDirection(SwipeRefreshLayoutDirection.BOTH);//同时支持上拉和下拉
 //srlGeneralMovie.setColorSchemeResources(R.color.colorAccent, R.color.bg_blue, R.color.orange_light, R.color.red_light);
 //srlGeneralMovie.setOnRefreshListener(direction -> {
